...
- **LLM e embeddings:** Cohere (`embed-multilingual-v3.0` para embeddings, `rerank-multilingual-v3.0` para reranking, `command-r-plus-08-2024` para geração de resposta), chamado via API route do Next.js (`/app/api/chat/route.ts`), nunca direto do client.
